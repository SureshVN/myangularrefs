...
Follow the belo steps to have the json-server host and serve angular application & notes api  
1. npm run build
2. json-server server/db.json --static dist
3. Launch the application in browser through http://localhost:3000/